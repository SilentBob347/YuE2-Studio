...
export const STRINGS = {
  en: {
    ...
    description: 'A desktop studio for the YuE2 song model: style and lyrics in, a full song with vocals and its sheet-music score out. Covers, exact replay, karaoke. One executable, no Python, runs offline on NVIDIA, AMD and Intel GPUs.',
    ...
    ctaNote: 'Windows 10/11 x64 and a GPU with 6 GB of VRAM: NVIDIA (GTX 16 / RTX 20 or newer) on CUDA, AMD and Intel on Vulkan. The models are downloaded from inside the studio when you decide to.',
  ...
  ru: {
    ...
    description: 'Десктопная студия для модели YuE2: на входе стиль и текст, на выходе целая песня с вокалом и её нотная партитура. Каверы, точный повтор, караоке. Один exe, без Python, работает офлайн на видеокартах NVIDIA, AMD и Intel.',
    ...
    ctaNote: 'Windows 10/11 x64 и видеокарта с 6 ГБ видеопамяти: NVIDIA (GTX 16 / RTX 20 и новее) через CUDA, AMD и Intel через Vulkan. Модели скачиваются из самой студии, когда вы решите.',
  ...
  zh: {
    ...
    description: 'YuE2 歌曲模型的桌面工作室：输入风格和歌词，得到带人声的完整歌曲及其乐谱。翻唱、精确重放、卡拉 OK。单个可执行文件，无需 Python，在 NVIDIA、AMD 和 Intel 显卡上离线运行。',
    ...
    ctaDonate: '支持项目',
    ctaNote: 'Windows 10/11 x64，显存 6 GB 以上的显卡：NVIDIA（GTX 16 / RTX 20 或更新）使用 CUDA，AMD 和 Intel 使用 Vulkan。模型在工作室内按你的决定下载。',
    featuresTitle: '功能',
  ...
  ja: {
    ...
    description: 'YuE2 ソングモデルのデスクトップスタジオ。スタイルと歌詞から、ボーカル入りのフルソングとその楽譜を生成します。カバー、完全な再現、カラオケ。単一の実行ファイル、Python 不要、NVIDIA・AMD・Intel の GPU でオフライン動作。',
    ...
    ctaDonate: 'プロジェクトを支援',
    ctaNote: 'Windows 10/11 x64 と VRAM 6 GB 以上の GPU：NVIDIA（GTX 16 / RTX 20 以降）は CUDA、AMD と Intel は Vulkan で動作します。モデルはスタジオ内から、あなたが決めたときにダウンロードされます。',
    featuresTitle: 'できること',
  ...
  ko: {
    ...
    description: 'YuE2 노래 모델을 위한 데스크톱 스튜디오: 스타일과 가사를 넣으면 보컬이 있는 완성곡과 그 악보가 나옵니다. 커버, 정확한 재현, 가라오케. 실행 파일 하나, Python 없이 NVIDIA, AMD, Intel 그래픽카드에서 오프라인으로 동작합니다.',
    ...
    ctaSource: 'GitHub 소스',
    ctaDonate: '프로젝트 후원',
    ctaNote: 'Windows 10/11 x64와 VRAM 6 GB 이상의 그래픽카드: NVIDIA(GTX 16 / RTX 20 이상)는 CUDA, AMD와 Intel은 Vulkan으로 동작합니다. 모델은 스튜디오 안에서 원할 때 내려받습니다.',
    featuresTitle: '기능',
