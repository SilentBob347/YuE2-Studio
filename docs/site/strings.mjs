...
export const STRINGS = {
  en: {
    ...
    features: [
      ...
      ['Your own LoRA', '5–20 songs of one artist or style become a LoRA on your card, with HOT-Step’s trainer and recipe. Every setting is editable, and datasets move between this studio and MiniMax Music3 Studio.'],
  ...
  ru: {
    ...
    features: [
      ...
      ['Своя LoRA', '5–20 песен одного артиста или стиля превращаются в LoRA на вашей видеокарте — тренером и рецептом HOT-Step. Каждую настройку можно поменять, датасеты переносятся между этой студией и MiniMax Music3 Studio.'],
    ...
    inside: [
      ...
      ['Обучение LoRA — HOT-Step ace-train', 'NVIDIA RTX 30 и новее, 11 GB видеопамяти', '8 GB, по желанию'],
  ...
  zh: {
    ...
    features: [
      ...
      ['训练你自己的 LoRA', '用同一歌手或风格的 5–20 首歌，在你的显卡上以 HOT-Step 的训练器和配方训练 LoRA。每项设置都可修改，数据集可在本工作室与 MiniMax Music3 Studio 之间迁移。'],
  ...
  ja: {
    ...
    features: [
      ...
      ['自分だけの LoRA', '同じアーティストやスタイルの 5〜20 曲から、HOT-Step のトレーナーとレシピで LoRA を自分の GPU で学習。設定はすべて変更でき、データセットはこのスタジオと MiniMax Music3 Studio の間で移せます。'],
  ...
  ko: {
    ...
    features: [
      ...
      ['나만의 LoRA', '한 아티스트나 스타일의 곡 5–20개로 HOT-Step의 트레이너와 레시피를 써서 내 GPU에서 LoRA를 학습합니다. 모든 설정을 바꿀 수 있고, 데이터셋은 이 스튜디오와 MiniMax Music3 Studio 사이를 오갑니다.'],
